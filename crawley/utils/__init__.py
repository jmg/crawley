...
from common import exit_with_error, search_class, add_to_path
from projects import import_user_module, generate_template, get_full_template_path, import_from_path
