...
public class _ParserTest {
	...
	public void pidoPrimerosElementosPorTagYRetornoElContenido() {
		...
		assertEquals("pido el primer 'div' del html", 
				"return PyQuery(html).query('div')[0]", new Parser().parse("first < tag:'div' => innerHTML"));
	}
	...
	public void pidoUltimosElementosPorTagYRetornoElContenido() {
		...
		assertEquals("pido el ultimo 'div' del html", 
				"return PyQuery(html).query('div')[-1]", new Parser().parse("last < tag:'div' => innerHTML"));
	}
	...
	public void pidoTodosLosElementosPorTagYRetornoElContenido() {
		...
		assertEquals("pido todos los 'div' del html",
				"return PyQuery(html).query('div')", new Parser().parse("all < tag:'div' => innerHTML"));
	}
	...
	public void pidoTodosElementoPorID() {
		...
		assertEquals("pido todos los elementos que tiene id = otroid",
				"return PyQuery(html).query('#otroid')", new Parser().parse("all < id:'otroID' => innerHTML"));
	}
	...
	public void pidoElPrimerElementoPorID() {
		...
		assertEquals("pido el primer elemento que tiene id = otroid",
				"return PyQuery(html).query('#otroid')[0]", new Parser().parse("first < id:'otroID' => innerHTML"));
	}
	...
	public void pidoElUltimoElementoPorID() {
		...
		assertEquals("pido el ultimo elemento que tiene id = otroid",
				"return PyQuery(html).query('#otroid')[-1]", new Parser().parse("last < id:'otroID' => innerHTML"));
	}
	...
	@Test
	public void pidoElementosPorDosClases() {
